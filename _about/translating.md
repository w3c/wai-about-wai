...
footer: |
  <p><strong>Date:</strong> Updated 26 June 2019.</p>
...
1. Check that there is not already a completed translation listed in {% include link.html to="/translations/" text="All WAI Translations" %} _**and**_ that there is not already an "Intent to Translate" to your language message in the [WAI Translations List Archives](http://lists.w3.org/Archives/Public/public-wai-translations/).
...
3. [Join the WAI Translations mailing list](mailto:public-wai-translations-request@w3.org?subject=subscribe) so you can keep up on related translations work.
