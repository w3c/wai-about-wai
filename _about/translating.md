...
* follow the steps in [Getting started]({{ "/about/translating/getting-started/" | relative_url }}) to _get the right file to translate_ and to ensure that the resource is ready for you to translate

### If you want to translate a WAI resource:

- Follow instructions in [Getting started]({{ "/about/translating/getting-started/" | relative_url }}) page.
- You will find more detailed guidance in [Translations Guides]({{ "/about/translating/guides/" | relative_url }}).
