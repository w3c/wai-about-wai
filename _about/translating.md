...
footer: |
  <p><strong>Date:</strong> Updated 22 June 2019.</p>
...
1. Check that there is not already a completed translation listed in {% include link.html to="/translations/" text="All WAI Translations" %} _**or**_ an "Intent to Translate" message in the [WAI Translations List Archives](http://lists.w3.org/Archives/Public/public-wai-translations/).
